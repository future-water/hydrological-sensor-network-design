...
if __name__ == "__main__":
    ...
    # 6. Prepare and create visualization
    flowlines_with_rmse, centroids = prepare_visualization_data(
        flowlines_gdf, 
        df_cleaned, 
        diff_nnse,
    ...
    plot_sensor_network(flowlines_with_rmse, centroids, save_path='sensor_network.png')
